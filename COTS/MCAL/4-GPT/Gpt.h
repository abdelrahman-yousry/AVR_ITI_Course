...
/********************WAVE FORM GENERATION MODES' OPTIONS*************************/
#define GPT_MODE_TIM1_NORMAL					0x0100 //
#define GPT_MODE_TIM1_CTC				      0x0104 // TCCR1B // CTC
...
#define GPT_ON_COMP_A_CHANNEL_1_ENABLED				0x08
#define GPT_ON_COMP_B_CHANNEL_1_ENABLED				0x10
#define GPT_OVF_INT_CHANNEL_2_ENABLED				  0x04
#define GPT_ON_COMP_CHANNEL_2_ENABLED				  0x80
...
typedef struct
{
	...
	u8 Gpt_u8CompareOutputMode;			//this is the wave generartion mode to select which mode the timer will be operated(normal/pwm/ctc ...)
...
*Input parameters :Gpt_ChannelNum copy_enuCh_Num,  u16 Value
 *
 * Return: the error status of the function, it has the following options
	1-Gpt_enuOk,
	2-Gpt_enuNullPointerException,
...
Gpt_tenuErrorStatus Gpt_vidOcmRegisterCbf(pfunc CallBackFn,Gpt_ChannelNum channel);
#endif /* GPT_H_ */
